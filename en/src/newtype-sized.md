...
```rust,editableenum VeryVerboseEnumOfThingsToDoWithNumbers {
    Add,
    Subtract,
}
...
```rust,editable/* Make it work with const generics */
...
```rust,editable/* Make it work with slice references */
fn main() {
...
```rust,editable/* Make it work in two ways */
use std::fmt::Display;
